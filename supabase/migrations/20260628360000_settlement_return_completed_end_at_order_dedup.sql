-- 정산 2건 일괄 수정
-- 1) sales_completed_reservations_v — return_completed_at fallback에 end_at 추가
-- 2) get_super_admin_settlement_reservations — payment_orders 취소 환불 중복 제거를 order_id 기준으로

-- ── 1) sales_return_completed_at + sales_completed_reservations_v ──
...
-- ── 2) get_super_admin_settlement_reservations ───────────────────
